...
public class PaymentsController(IPaymentService paymentService,
    IUnitOfWork UoW, ILogger<PaymentsController> logger, IConfiguration config,
    IHubContext<NotificationHub> hubContext) : BaseApiController
{
    ...
    public async Task<ActionResult> StripeWebhook()
    {
        ...
        try
        {
            var stripeEvent = ConstructStrpipeEvent(json);
    ...
    private Event ConstructStrpipeEvent(string json)
    {
        try
        {
